...
import shakram02.ahmed.lwa.otp.Base32String.DecodingException;
...
public class AccountDb {
    ...
    private String getAccountDbOpenFailedErrorString(Context context) {
        ...
        for (String directory : dirsToStat) {
            try {
                ...
                error.append(directory).append(" directory stat (my UID: ").append(myUid);
                if (ownerUidName == null) {
                    error.append("): ");
                } else {
                    error.append(", dir owner UID name: ").append(ownerUidName).append("): ");
                }
                error.append(stat.toString()).append("\n");
            } catch (IOException e) {
                error.append(directory).append(" directory stat threw an exception: ").append(e).append("\n");
            }
        }
     ...
     */
    // @VisibleForTesting
    private static Collection<String> listTableColumnNamesLowerCase(
