...
public class CountdownIndicator extends View {
    ...
    private static final int STROKE_WITH = 6;
    /**
    ...
    public CountdownIndicator(Context context, AttributeSet attrs) {
        ...
        mRemainingSectorPaint.setColor(DEFAULT_COLOR);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mDrawingRect == null || mDrawingRect.height() != getHeight() - 1) {
            mDrawingRect = new RectF(1, 1, getWidth() - 1, getHeight() - 1);

            mGapRect = new RectF(STROKE_WITH, STROKE_WITH, getWidth() - STROKE_WITH,
                    getHeight() - STROKE_WITH);
        }

        if (remainingSectorStartAngle < 360) {
            canvas.drawArc(mDrawingRect,
        ...
        canvas.drawOval(mGapRect, mBorderPaint);
    }
